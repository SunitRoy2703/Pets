...
public class EditorActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
   ...
   private MenuItem menuItem;
    ...
    private void setupSpinner() {
        ...
        // Apply the adapter to the spinner0
    ...
    private void savePet() {
        ...
        if (mCurrentPetUri == null &&
                TextUtils.isEmpty(nameString) && TextUtils.isEmpty(breedString) && TextUtils.isEmpty(weightString) && mGender == PetEntry.GENDER_UNKNOWN) {
            return;
        }
        ...
        if (mCurrentPetUri == null) {
            ...
            if (rowsAffected == 0) {
                Toast.makeText(this, "Error updating the pet ", Toast.LENGTH_SHORT).show();
            } else {
    ...
    private void deletePet() {
        ...
        if (mCurrentPetUri != null) {
            ...
            if (rowsDeleted == 0) {
                ...
                Toast.makeText(this, getString(R.string.editor_deleted), Toast.LENGTH_SHORT).show();
            }
